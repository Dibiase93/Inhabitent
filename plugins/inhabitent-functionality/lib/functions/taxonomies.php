...
function inhabitent_tax_adventure_type() {
	...
	$labels = array(
		'name'                       => _x( 'Adventure Types', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Adventure Type', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Adventure Types', 'text_domain' ),
		'all_items'                  => __( 'All Adventure Types', 'text_domain' ),
		'parent_item'                => __( 'Parent Adventure Types', 'text_domain' ),
		'parent_item_colon'          => __( 'Parent Adventure Types:', 'text_domain' ),
		'new_item_name'              => __( 'New Adventure Type Name', 'text_domain' ),
		'add_new_item'               => __( 'Add New Adventure Types', 'text_domain' ),
		'edit_item'                  => __( 'Edit Adventure Types', 'text_domain' ),
		'update_item'                => __( 'Update Adventure Types', 'text_domain' ),
		'view_item'                  => __( 'View Adventure Types', 'text_domain' ),
		'separate_items_with_commas' => __( 'Separate Adventure Types with commas', 'text_domain' ),
		'add_or_remove_items'        => __( 'Add or remove Adventure Types', 'text_domain' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'text_domain' ),
		'popular_items'              => __( 'Popular Adventure Types', 'text_domain' ),
		'search_items'               => __( 'Search Items', 'text_domain' ),
		'not_found'                  => __( 'Not Found', 'text_domain' ),
		'no_terms'                   => __( 'No Adventure Types', 'text_domain' ),
		'items_list'                 => __( 'Adventure Types list', 'text_domain' ),
		'items_list_navigation'      => __( 'Adventure Types list navigation', 'text_domain' ),
	);
	$args = array(
		'labels'                     => $labels,
		'hierarchical'               => true,
